<img align="right" src="https://komarev.com/ghpvc/?username=ogabrielaugustto&color=0077ff"><br>
...
> Desenvolvedor front-end, especializado em PHP, JavaScript, React, HTML, CSS, GIT e API REST. Experiência sólida em criação de aplicações web dinâmicas e responsivas, aplicando as melhores práticas para otimização de desempenho. Comprometido em proporcionar soluções inovadoras e eficientes no universo do desenvolvimento web.
